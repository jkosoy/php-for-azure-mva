<?php
	/*
	 * this example swaps sessions out for cookies, which saves the information on the user's machine.
	 * some new functions: unset() to clear a variable; setcookie() to um, set a cookie. :)
	 */
	...
	// this is a secret parameter to delete cookies
	...
	elseif($page == 'rsvp') {
		// if has_rsvped exists in our cookie the user must've already submitted.
