<?php
	/*
	 * this example builds off our previous one to show a thank you page for the RSVP form.
	 */
	...
	// if the page is the RSVP page, see if a user posted anything and if so show the thanks page.
	elseif($page == 'rsvp') {
		if(isset($_POST['name'])) {
			$page = 'thanks';
		}
